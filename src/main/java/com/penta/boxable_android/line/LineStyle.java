package com.penta.boxable_android.line;
...
public class LineStyle {
	 ...
	 *            The line width
	 */
	public LineStyle(final int color, final float width) {
		this.color = color;
		this.width = width;
	}
	 ...
	 */
	public static LineStyle produceDotted(final int color, final int width) {
	 ...
	 * @return new styled line
	 */
	public static LineStyle produceDashed(final int color, final int width) {
	 ...
	 * @return new styled line
	 */
	public static LineStyle produceDashed(final int color, final int width, final float[] dashArray,
